module postgresql-connection-manager

replace github.com/WoodProgrammer/postgresql-connection-manager/lib => ./lib

replace github.com/WoodProgrammer/postgresql-connection-manager/controller => ./controller
